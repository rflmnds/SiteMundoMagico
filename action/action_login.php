<?php
    ...
    // if (!$usuario) {
    //     $sql = "SELECT * FROM usuario u INNER JOIN adm a on u.idUsuario = a.idUsuario WHERE Login = '$login' and Senha = '$senha'";
    //     $result = mysqli_query($conn,$sql) or die('Falha ao buscar dados do funcionario');
    //     $adm = mysqli_fetch_array($result);
